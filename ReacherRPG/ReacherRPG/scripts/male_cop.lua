GameObject = {
	...
	init = function( self )
		...
		local tileset = getTilesetByName(self.host,"aliens")
 		...
 		pushAnimation(self.host, "walk_up",    tileset, 10, true, { 9,  10,  11  })
 		pushAnimation(self.host, "walk_left",  tileset, 10, true, { 21, 22, 23 })
 		pushAnimation(self.host, "walk_down",  tileset, 10, true, { 33, 34, 35 })
 		pushAnimation(self.host, "walk_right", tileset, 10, true, { 45, 46, 47 })
